(() => {
  ...
  /* =========================================================
     MARTINE LAW - TEXAS / AUSTIN LSA SERVICE AREAS
     INCLUDED AREAS ONLY
     =========================================================
  ...
  const LOCK =
    "__MARTINE_TX_AUSTIN_LSA_RUNNING__";


  if (window[LOCK]) {
    console.warn(
      "⚠ Austin Service Area automation is already running."
    );
    return;
  }
  ...
  APP.serviceAreas = [
    {
      name: "Travis County",
      aliases: ["Travis County"]
    },
    {
      name: "Williamson County",
      aliases: ["Williamson County"]
    },
    {
      name: "Hays County",
      aliases: ["Hays County"]
    ...
    {
      name: "Bastrop County",
      aliases: ["Bastrop County"]
    },
    {
      name: "Caldwell County",
      aliases: ["Caldwell County"]
    },
    {
      name: "Burnet County",
      aliases: ["Burnet County"]
    },
    {
      name: "Blanco County",
      aliases: ["Blanco County"]
    },
    {
      name: "Lee County",
      aliases: ["Lee County"]
  ...
  APP.waitUntilVisible =
    async () => {
      ...
      console.warn(
        "⏸ Austin LSA automation paused because the page is hidden."
      );
  ...
  APP.typeSearch =
    async (
      ...
      /*
       * Helps wake Google's autocomplete listener.
       */
  ...
  APP.addArea =
    async area => {
      ...
      for (
        ...
        /*
         * Verify that Google added the county.
         */
  ...
  APP.process =
    async () => {
      ...
      for (
        ...
        console.log(
          `🔄 AUSTIN PASS ${pass}/${APP.settings.maxPasses}`
        );
  ...
  APP.audit = () => {
    ...
    if (!missing.length) {
      ...
      console.log(
        "✅ All 11 Austin-area counties are included."
      );
  ...
  (async () => {
    ...
    try {
      ...
      if (
        ...
        console.warn(
          "🛑 Austin Service Area automation stopped."
        );

      } else {

        console.error(
          "❌ TEXAS AUSTIN LSA ERROR:",
          error
        );
      }
