(() => {
  ...
  const LOCK = "__TX_LSA_BUSINESS_DETAILS_V7__";

  if (window[LOCK]) {
    console.warn("⚠ Texas Business Details already running.");
    return;
  }
  ...
  const run = async () => {
    ...
    console.log(
      "🏁 TEXAS BUSINESS DETAILS COMPLETE"
    );
  };
